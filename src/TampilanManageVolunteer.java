 ...
 * @author Angga
 */
public class TampilanManageVolunteer extends javax.swing.JFrame {
    ...
    public TampilanManageVolunteer() {
        this.setLocationRelativeTo(null);
        initComponents();
        crud.getVolunteerTabel(tblVolunteer, "");
        model = (DefaultTableModel)tblVolunteer.getModel();
        tblVolunteer.setRowHeight(40);
        tblVolunteer.setShowGrid(true);
        tblVolunteer.setGridColor(Color.green);
        tblVolunteer.setSelectionBackground(Color.black);
    ...
    private void initComponents() {
        ...
        tblVolunteer.setBackground(new java.awt.Color(255, 255, 204));
        tblVolunteer.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        tblVolunteer.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Nama", "Alamat", "Email", "Password", "Foto"
            }
        ));
        tblVolunteer.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblVolunteerMouseClicked(evt);
            }
        });
        tblVolunteer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tblVolunteerKeyReleased(evt);
            }
        });
    ...
    private void tblVolunteerKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblVolunteerKeyReleased
        if(evt.getKeyCode() == KeyEvent.VK_UP || evt.getKeyCode() == KeyEvent.VK_DOWN)
            rowIndex = tblVolunteer.getSelectedRow();
    }//GEN-LAST:event_tblVolunteerKeyReleased

    private void tblVolunteerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVolunteerMouseClicked
            rowIndex = tblVolunteer.getSelectedRow();
    }//GEN-LAST:event_tblVolunteerMouseClicked

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
                                                 
                    boolean cek = tblVolunteer.getSelectionModel().isSelectionEmpty();
        if(cek)
        {
        ...
        else
        {
            crud.getVolunteerTabel(tblVolunteer, "");
            model = (DefaultTableModel)tblVolunteer.getModel();
            crud.crudVolunteer('d', model.getValueAt(rowIndex, 0).toString(), null, null, null, null, null, null);        
            TampilanManageVolunteer.tblVolunteer.setModel(new DefaultTableModel(null,new Object[]{"ID","Nama","Email","Password","Alamat","Divisi","Foto"}));
            crud.getVolunteerTabel(TampilanManageVolunteer.tblVolunteer, "");
        }
    ...
    public static javax.swing.JTable tblVolunteer;
